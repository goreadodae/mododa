...
<script>
   ...
   $(document).ready(function() {
      resizeContent();
	    ...
	    $("#btn1").click(function(){
	    	...
	    	$('#contents').load('/layout/test.jsp');
	    	return false;
	    });
	    $("#btn2").click(function(){
	    	
	    	$('#contents').load('/layout/leftbar.jsp');
	    	return false;
	    });
	    $("#btn3").click(function(){
	    	
	    	$('#contents').load('/gotoProTitle.do');
	    	return false;
	    });
   });
   ...
   function changeContents(category){
...
<body>
   <div>
      ...
      <div class="row">
         ...
         <div class="col-3" id="background">
            <div class="leftbar">
               ...
               <ul>
                  ...
                  <li class="list-group-item" onclick="changeContents('뉴스피드');"><img src="../resources/images/layout-img/lightning.png" class="icon"> 뉴스피드</li>
                  <li class="list-group-item" onclick="changeContents('호출');"><img src="../resources/images/layout-img/arroba.png" class="icon"> 호출된 글</li>
                  <li class="list-group-item" onclick="changeContents('북마크');"><img src="../resources/images/layout-img/bookmark.png" class="icon"> 북마크</li>
               ...
               <ul>
                  ...
                  <li class="list-group-item"><img
                     src="../resources/images/layout-img/plus.png" class="icon">
                     새 프로젝트 만들기</li>
               </ul>
         ...
         <!-- contents -->
         <div class="col-6" id="contents"></div>
