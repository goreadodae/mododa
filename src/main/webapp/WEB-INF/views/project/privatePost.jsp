						...
						if(searchResult.length == 0) {
							...
							for(var i=0 ; i<searchResult.length ; i++) {
								...
								console.log(printDate); */
	 							...
	 							result += '<a onclick="getPost('+searchResult[i].postNo+');" id="postTitle" class="btn btn-link" style="float:left;"><b>'+searchResult[i].postTitle+'</b></a></div>'
			...
			<ul class="feed-list">
				<c:if test="${empty postList }">
						<center>
							...
							<span font-size="12px;">아직 프라이빗 공간에 글이없어요....먼저 글을 남겨보면 어떨까요??</span>
						</center>
					</c:if>
