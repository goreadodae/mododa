...
.nTitle a:hover{
  ...
  <body id="page-top">
   ...
   <tr id="NoticeTitles">
      <td>${s.noticeNo}</td>
      <td class="nTitle"><a href="/noticeDetail.do?noticeNo=${s.noticeNo}">${s.noticeTitle}</a></td>
      <td>관리자</td>
      ...
      <div class="btn-group mr-2" role="group" aria-label="첫번째 그룹">
       ${searchCount}
		...
		<input type="submit" class="btn btn-secondary" id="nWrite" style="float:right; margin-right:300px;" value="글쓰기"> 
		</form>
