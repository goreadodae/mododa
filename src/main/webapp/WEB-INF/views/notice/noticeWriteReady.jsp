  ...
  <body id="page-top">
    ...
    <header class="masthead bg-primary text-white text-center" style="padding-bottom:1%;">
      <div class="container">
        ...
        <h1 class="text-uppercase mb-0">공지사항 글쓰기</h1>
...
<body>
	...
	<form action="/noticeWrite.do">
			제목<input type="text" class="form-control" size=90 name="title" /><br>
			<textarea class="form-control" rows="20" cols="100" id="text" name="contents"
