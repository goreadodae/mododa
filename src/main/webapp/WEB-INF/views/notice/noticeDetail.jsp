...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <body id="page-top">
	...
	<!-- 여기 안쪽 부분 수정하면 됨 -->
	<div style="margin-left:15%; margin-right:15%; padding-top:3%; padding-bottom:3%; border:1px solid black;">
	
	
	<label>번호</label> <input type="text" value="${noticeDetail.noticeNo}"> <br>
	<label>제목</label> <input type="text" value="${noticeDetail.noticeTitle}"> <br>
	<label>작성일</label> <input type="text" value="${noticeDetail.noticeWriteDate}"> <br>
	<label>조회수</label> <input type="text" value="${noticeDetail.noticeViewCount}"> <br>
	<label>내용</label> <textarea>${noticeDetail.noticeContents} </textarea>
		...
		<input type="submit" value="글삭제" class="btn btn-primary" style="float:left;"> 
		<input type="hidden" value="${noticeDetail.noticeNo}" name="noticeNo" >
		</form>
		<form action="/noticeUpdateReady.do">
		<input type="submit" value="글수정" class="btn btn-primary"  style="float:left;"> 
		<input type="hidden" value="${noticeDetail.noticeNo}" name="noticeNo" >
		</form>	
