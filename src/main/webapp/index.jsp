      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-13 mx-auto">
              <img class="img-fluid" src="../resources/index_img/intro_img/intro_1_resize.png" alt="" style="padding-bottom: 100px;">
          </div>
          <div class="col-lg-13 mx-auto">
              <img class="img-fluid" src="../resources/index_img/intro_img/intro_2_resize.png" alt="" style="padding-bottom: 100px;">
          </div>
          <div class="col-lg-13 mx-auto">
              <img class="img-fluid" src="../resources/index_img/intro_img/intro_3_resize.png" alt="" style="padding-bottom: 100px;">
          </div>
          <div class="col-lg-13 mx-auto">
              <img class="img-fluid" src="../resources/index_img/intro_img/intro_4_resize.png" alt="" style="padding-bottom: 100px;">
          </div>
          <div class="col-lg-13 mx-auto">
              <img class="img-fluid" src="../resources/index_img/intro_img/intro_5_resize.png" alt="" style="padding-bottom: 100px;">
          </div>
          <div class="col-lg-13 mx-auto">
              <img class="img-fluid" src="../resources/index_img/intro_img/intro_6_resize.png" alt="" style="padding-bottom: 100px;">
          </div>
          <div class="col-lg-3 mx-auto">
             <a class="portfolio-item d-block mx-auto" href="#join-modal" id="joinAtag">
              <button class="btn btn-primary btn-xl" id="sendMessageButton" style="color:#339966; font-weight:1000;">모두다와 함께하기</button>
             </a>
          </div>
        </div>
      </div>
