...
public class Todo {
	...
	private String todoWriterPicture;
	public Todo() {
		super();
	...
	public Todo(int todoNo, int todoPostNo, int todoProNo, String todoTitle, String todoContent, int todoWriter,
			...
			String todoMemberName, String todoProjectName, String todoMemberPicture, String todoWriterPicture) {
		super();
		this.todoNo = todoNo;
		...
		this.todoWriterPicture = todoWriterPicture;
	}
	...
	public String getTodoWriterPicture() {
		return todoWriterPicture;
	}
	public void setTodoWriterPicture(String todoWriterPicture) {
		this.todoWriterPicture = todoWriterPicture;
	}
